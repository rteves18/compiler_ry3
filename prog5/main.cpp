...
int main (int argc, char** argv) {
  ...
  char* filename = argv[argc - 1];
      ...
      string filename_ast = filein.substr(0, last);
      string filename_sym = filein.substr(0, last);
      string filename_oil = filein.substr(0, last);
      filename_str += ".str";
      filename_tok += ".tok";
      filename_ast += ".ast";
      filename_sym += ".sym";
      ...
      string newfile_ast = filename_ast;
      string newfile_sym = filename_sym;
      string newfile_oil = filename_oil;

      //open .tok file
      tokfile = fopen(newfile_tok.c_str(), "w"); 

      //open .ast file
      astfile = fopen(newfile_ast.c_str(), "w");
      
      //open .sym file
      symfile = fopen(newfile_sym.c_str(), "w");

      //open .oil file
      oilfile = fopen(newfile_oil.c_str(), "w");
      ...
      emit_code(oilfile, yyparse_astree);
